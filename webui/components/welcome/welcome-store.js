...
import { store as memoryStore } from "../settings/memory/memory-dashboard-store.js";
  ...
  executeAction(actionId) {
    switch (actionId) {
      ...
      case "memory":
        ...
        break;
      case "website":
        window.open("https://agix.ai", "_blank");
        break;
      case "github":
        window.open("https://your-forgejo-instance.example.com/your-org/agi-experimental", "_blank");
        break;
    }
  },
};
