...
class SaveToolCallFile(Extension):
    async def execute(self, data: dict[str, Any] | None = None, **kwargs):
        ...
        # ADR-83: This path is Zone 1 (framework-internal: /agix/tmp/chats/).
        # It is used ONLY by framework code for history compaction and context
        # window management. It must NEVER be exposed to agents via hints,
        # §§include references, or any agent-visible context.
        data["file"] = new_file
