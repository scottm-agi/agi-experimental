...
class SSHInteractiveSession:
    ...
    async def send_command(self, command: str):
        ...
        # else:
        command = command + "\n"
        self.last_command = command.encode("utf-8", errors="replace")
    ...
    async def read_output(
        ...
        decoded_partial_output = strings.clean_string(decoded_partial_output)
        decoded_full_output = strings.clean_string(decoded_full_output)
