"""
Line-Item Extraction Patterns — Compiled Regex and Constants

All regex patterns and constant data used by the prompt line-item extraction
pipeline. Extracted from prompt_line_item_extractor.py for maintainability.

This module contains NO functions — only compiled regex objects, frozensets,
dicts, and lists. It is imported by:
- prompt_line_item_extractor.py (extract_line_items)
- line_item_classifier.py (classify_requirement_text, score_ui_surface)
- line_item_expander.py (expand_compound_sub_features)
- line_item_weighted.py (extract_weighted_candidates)
"""
